...
VoltageReading& VoltageReading::voltage(const float &v) noexcept {
    m_voltage = v;
    return *this;
}
float VoltageReading::voltage() const noexcept {
    return m_voltage;
}
...
int32_t DistanceReading::ID() {
    return 1039;
}

const std::string DistanceReading::ShortName() {
    return "DistanceReading";
}
const std::string DistanceReading::LongName() {
    return "opendlv.proxy.DistanceReading";
}

DistanceReading& DistanceReading::distance(const float &v) noexcept {
    m_distance = v;
    return *this;
}
float DistanceReading::distance() const noexcept {
    return m_distance;
}
...
int32_t WheelSpeedReading::ID() {
    return 1047;
}

const std::string WheelSpeedReading::ShortName() {
    return "WheelSpeedReading";
}
const std::string WheelSpeedReading::LongName() {
    return "opendlv.proxy.WheelSpeedReading";
}

WheelSpeedReading& WheelSpeedReading::wheelSpeed(const float &v) noexcept {
    m_wheelSpeed = v;
    return *this;
}
float WheelSpeedReading::wheelSpeed() const noexcept {
    return m_wheelSpeed;
}
...
WeightReading& WeightReading::weight(const float &v) noexcept {
    m_weight = v;
    return *this;
}
float WeightReading::weight() const noexcept {
    return m_weight;
}
...
VoltageRequest& VoltageRequest::voltage(const float &v) noexcept {
    m_voltage = v;
    return *this;
}
float VoltageRequest::voltage() const noexcept {
    return m_voltage;
}
...
int32_t WheelSpeedRequest::ID() {
    return 1094;
}

const std::string WheelSpeedRequest::ShortName() {
    return "WheelSpeedRequest";
}
const std::string WheelSpeedRequest::LongName() {
    return "opendlv.proxy.WheelSpeedRequest";
}

WheelSpeedRequest& WheelSpeedRequest::wheelSpeed(const float &v) noexcept {
    m_wheelSpeed = v;
    return *this;
}
float WheelSpeedRequest::wheelSpeed() const noexcept {
    return m_wheelSpeed;
}
...
GroundSurfaceArea& GroundSurfaceArea::x1(const float &v) noexcept {
    m_x1 = v;
    return *this;
}
float GroundSurfaceArea::x1() const noexcept {
    return m_x1;
}

GroundSurfaceArea& GroundSurfaceArea::y1(const float &v) noexcept {
    m_y1 = v;
    return *this;
}
float GroundSurfaceArea::y1() const noexcept {
    return m_y1;
}

GroundSurfaceArea& GroundSurfaceArea::x2(const float &v) noexcept {
    m_x2 = v;
    return *this;
}
float GroundSurfaceArea::x2() const noexcept {
    return m_x2;
}

GroundSurfaceArea& GroundSurfaceArea::y2(const float &v) noexcept {
    m_y2 = v;
    return *this;
}
float GroundSurfaceArea::y2() const noexcept {
    return m_y2;
}

GroundSurfaceArea& GroundSurfaceArea::x3(const float &v) noexcept {
    m_x3 = v;
    return *this;
}
float GroundSurfaceArea::x3() const noexcept {
    return m_x3;
}

GroundSurfaceArea& GroundSurfaceArea::y3(const float &v) noexcept {
    m_y3 = v;
    return *this;
}
float GroundSurfaceArea::y3() const noexcept {
    return m_y3;
}

GroundSurfaceArea& GroundSurfaceArea::x4(const float &v) noexcept {
    m_x4 = v;
    return *this;
}
float GroundSurfaceArea::x4() const noexcept {
    return m_x4;
}

GroundSurfaceArea& GroundSurfaceArea::y4(const float &v) noexcept {
    m_y4 = v;
    return *this;
}
float GroundSurfaceArea::y4() const noexcept {
    return m_y4;
}
...
AimDirection& AimDirection::zenithAngle(const float &v) noexcept {
    m_zenithAngle = v;
    return *this;
}
float AimDirection::zenithAngle() const noexcept {
    return m_zenithAngle;
}
